...
export const SWITZERLAND_COUNTRY_LOCATION: LocationDefinition = {
  slug: "switzerland",
  label: "Switzerland",
  scope: "country",
  country: "Switzerland",
  areaLabelSingular: "Canton",
  areaLabelPlural: "Cantons",
  chartTitle: "Switzerland Crime by Canton",
  note:
    "Switzerland uses the Swiss Federal Statistical Office Police Crime Statistics table for Criminal Code offences by canton. The data is police-recorded and should be read as recorded offences rather than a direct measure of underlying victimisation.",
  sources: [
    {
      label: "FSO STAT-TAB: Criminal offences registered by the police according to the Swiss Criminal Code by canton",
      url: "https://www.pxweb.bfs.admin.ch/pxweb/en/px-x-1903020100_101/px-x-1903020100_101.px/",
    },
    {
      label: "FSO Police Crime Statistics methodology",
      url: "https://dam-api.bfs.admin.ch/hub/api/dam/assets/35957079/master",
    },
  ],
  categories: [
    {
      sourceLabels: ["Offence - total"],
      label: "All recorded offenses",
      shortLabel: "All offenses",
      color: "#7dd3fc",
      isDefault: false,
    ...
    {
      sourceLabels: ["Homicides (art. 111 - 113/116)"],
      label: "Homicide",
      shortLabel: "Homicide",
      color: "#ef4444",
      isDefault: false,
    ...
    {
      sourceLabels: ["Serious assault (art. 122)"],
      label: "Serious assault",
      shortLabel: "Serious assault",
      color: "#0ea5e9",
      isDefault: false,
      sortOrder: 6,
    },
    {
      sourceLabels: ["Common assault (art. 123)", "Acts of aggression (art. 126)"],
      label: "Assault",
      shortLabel: "Assault",
      color: "#38bdf8",
      isDefault: true,
    ...
    {
      sourceLabels: ["Vehicle theft (art. 139)"],
      label: "Vehicle theft",
      shortLabel: "Vehicle theft",
      color: "#4f46e5",
      isDefault: false,
    ...
    {
      sourceLabels: ["Theft from/ out of a vehicle (art. 139)"],
      label: "Theft from vehicles",
      shortLabel: "From vehicles",
      color: "#14b8a6",
      isDefault: false,
    ...
    {
      sourceLabels: ["Criminal damage (art. 144)"],
      label: "Criminal damage",
      shortLabel: "Criminal damage",
      color: "#f59e0b",
      isDefault: false,
    ...
    {
      sourceLabels: ["Threatening behaviour (art. 180)"],
